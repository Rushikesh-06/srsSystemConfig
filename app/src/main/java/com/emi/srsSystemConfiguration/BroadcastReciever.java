...
//                sync_params.put("IMEINumber", );
            ...
            JsonObjectRequest sync_api_status = new JsonObjectRequest(Request.Method.POST, "http://api.srsemiprotect.com/api/app/CustomerStatusSync", sync_params, new Response.Listener<JSONObject>() {
                @Override
